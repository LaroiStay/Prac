...
class PacketManager
{
    ...
    {
        m_makeFuc.Add((ushort)PacketID.S_BroadcastEnterGame, MakePacket<S_BroadcastEnterGame>);
        m_handler.Add((ushort)PacketID.S_BroadcastEnterGame, PacketHandler.S_BroadcastEnterGameHandler);

        m_makeFuc.Add((ushort)PacketID.S_BroadcastLeaveGame, MakePacket<S_BroadcastLeaveGame>);
        m_handler.Add((ushort)PacketID.S_BroadcastLeaveGame, PacketHandler.S_BroadcastLeaveGameHandler);

        m_makeFuc.Add((ushort)PacketID.S_PlayerList, MakePacket<S_PlayerList>);
        m_handler.Add((ushort)PacketID.S_PlayerList, PacketHandler.S_PlayerListHandler);

        m_makeFuc.Add((ushort)PacketID.S_BroadcastMove, MakePacket<S_BroadcastMove>);
